 ...
 */
@ApiModel(description = "Array of menu option objects. See below for details.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-01-31T14:54:48.237Z")
public class OptionsListMenus extends ArrayList<Option> {
  ...
  public String toString() {
    ...
    sb.append("class OptionsListMenus {\n");
